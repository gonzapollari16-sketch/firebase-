            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                ...
                <CardContent className="p-6 space-y-4">
                  <div className="flex gap-2">
                    <Select onValueChange={(v) => methods.setValue('moneda', v)} defaultValue="USD">
                      <SelectTrigger className="w-24 bg-black/40 border-white/10 h-12">
                        <SelectValue />
                      </SelectTrigger>
                      <SelectContent>
                    ...
                    <Input type="number" {...methods.register('precio', { required: true })} placeholder="Precio" className="flex-1 bg-black/40 border-white/10 h-12" />
                  </div>
                </CardContent>
              </Card>
              ...
              <Card className="bg-white/[0.03] border-white/10">
                ...
                <CardContent className="p-6">
                  ...
                  {!methods.watch('lat') && (
                    <div className="mt-4 p-3 rounded-lg bg-red-500/10 border border-red-500/20 flex gap-2 items-center text-red-400 text-xs font-bold animate-pulse">
                      <AlertCircle className="h-4 w-4" /> Ubicación obligatoria
                    </div>
                  )}
                </CardContent>
              </Card>
